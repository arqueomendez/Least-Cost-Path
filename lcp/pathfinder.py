...
def cost_surface_calculator(cost_raster, start_coords):
    ...
    El raster de entrada debe ser float64.  El caller es responsable de hacer el
    cast una sola vez antes de entrar al bucle principal para evitar copias redundantes.
    """
